...
const LoadCraftitem = ({ craftItem }) => {
    ...
    return (
        <div >
            ...
            <div  data-aos="flip-right"   data-aos-duration="1000"  className="w-96 h-full rounded-md shadow-md bg-cyan-200 dark:text-gray-800">
                <img src={image} alt="" className="object-cover object-center w-full rounded-t-md h-72 dark:bg-gray-500" />
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-semibold text-green-600 tracking-wide">{subcategory_Name}</h2>
